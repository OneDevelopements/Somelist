...
export default Template(function rules(){
    return(
        <div className="p-5 lg:p-10 py-[10rem] lg:py-[12rem] rounded-lg min-h-screen">
            <h1 className="italic text-violet-600 text-7xl font-bold">BOT RULES</h1>
            ...
            <h1 className="mt-10 underline italic decoration-4 decoration-violet-600 text-3xl font-bold">General</h1>

            <ol className="mt-3 list-decimal mx-10">
                <li className="text-md my-1 font-medium">Follow the <a className="text-violet-500 font-bold" href='https://discord.com/terms' >Discord Developer TOS</a>. Breaking the TOS can lead to us reporting your bot, and disabling your account.</li>
                <li className="text-md my-1 font-medium">Minimal NSFW. NSFW should not be accessible in channels not marked as NSFW.</li>

            </ol>
            <h1 className="mt-10 underline italic decoration-4 decoration-violet-600 text-3xl font-bold">Page Content</h1>
            <ol className="mt-3 list-decimal mx-10">
                ...
                <li className="text-md my-1 font-medium">No NSFW. Unless your bot has been marked as NSFW, your bot's page should <span className='text-violet-500 font-bold'>NOT</span> include NSFW materials.</li>

            </ol>

            <h1 className="mt-10 underline italic decoration-4 decoration-violet-600 text-3xl font-bold">Bot Features</h1>
            <ol className="mt-3 list-decimal mx-10">
