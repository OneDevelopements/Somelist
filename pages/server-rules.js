...
export default Template(function rules(){
    return(
        <div className="p-5 lg:p-10 py-[10rem] lg:py-[12rem] rounded-lg min-h-screen">
            <h1 className="italic text-violet-600 text-7xl font-bold">SERVER RULES</h1>
            <ol className="mt-10 list-decimal mx-10">
                <li className="text-md my-1 font-medium">Follow the <a className="text-violet-600" href='https://discord.com/terms' >discord TOS</a>. Breaking the TOS can lead to us reporting your account.</li>
