            ...
            try {
              setFeatured(
                ...
                <Tr>
                  ...
                  <Td><HStack spacing={'10px'}><Skeleton><Button colorScheme={'green'}>Approve</Button></Skeleton><Skeleton><Button colorScheme={'red'}>Deny</Button></Skeleton></HStack></Td>
                </Tr>
                </>
                )
                  ...
                  .then((json) => {
                    ...
                    <Tr>
                      <Td>{data.name}</Td>
                      <Td>{data.id}</Td>
                      <Td><HStack spacing={'10px'}><Button colorScheme={'green'} onClick={function(){
                        $.ajax({
                      ...
                      }}>Approve</Button><Button colorScheme={'red'} onClick={function(){
                        window.open(`/deny/${data.id}`).focus();
                      }}>Deny</Button></HStack></Td>
                    </Tr>));
                  })
