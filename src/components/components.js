...
export const Navlink = props => {
  ...
  <Button h={'30px'} margin={'0'} onClick={function(){
...
export const Navbar = props => {
  return (
    <nav>
    <Box textAlign="center" fontSize="xl" bg={useColorModeValue('gray.100', 'gray.900')}>
      <Grid p={3}>
        <Flex h='60px;'>
        <Navbrand href='/'>
          <Image src='./Somelist.png' h={'50px'} w={'50px'} borderRadius={'100%'}/>
        </Navbrand>
